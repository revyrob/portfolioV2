...
function Skills() {
  ...
  return (
    ...
    <div className='bg-white rounded-lg min-h-[350px] w-[90%] md:w-3/4 m-auto ' style={{backgroundImage: `url(${ladySkills})`, backgroundRepeat:'no-repeat', backgroundPosition:"left", backgroundSize:"30%"}} >
